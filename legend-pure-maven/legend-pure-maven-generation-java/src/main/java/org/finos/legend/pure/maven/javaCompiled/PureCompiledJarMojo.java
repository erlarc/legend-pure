...
public class PureCompiledJarMojo extends AbstractMojo
{
    ...
    public void execute() throws MojoExecutionException
    {
        ...
        try (URLClassLoader cl = this.buildClassLoader(savedClassLoader, log))
        {
    ...
    public URLClassLoader buildClassLoader(ClassLoader parent, Log log) throws DependencyResolutionException
    {
        ...
        log.debug("    Project classLoader URLs " + Arrays.toString(dependencyUrls));
        return new URLClassLoader(dependencyUrls, parent);
    }
}
